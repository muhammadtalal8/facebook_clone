...
List<PostModel> postData = [
  PostModel(
    ...
    postTitle: "This is my new profile picture of me jnubibyhutfersr",
  ...
  PostModel(
    ...
    time: "JUst Now",
    moreOnPressed: () => print('More clicked'),
    postTitle: "This is my new profile picture mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm",
    postImage: "images/man2.avif",
    likeOnpressed: () => {print('like clicked')},
    commentOnPressed: () => print("Comment clicked"),
    shareOnPressed: () => print('share clicked'),
  ...
  PostModel(
    ...
    time: "JUst Now",
    moreOnPressed: () => print('More clicked'),
    postTitle: "This is my new profile picturemhhhhhhhhhhhhftyyyyyyyyyyyyyyyyyyyyyyyyyy",
    postImage: "images/man2.avif",
    likeOnpressed: () => {print('like clicked')},
    commentOnPressed: () => print("Comment clicked"),
    shareOnPressed: () => print('share clicked'),
